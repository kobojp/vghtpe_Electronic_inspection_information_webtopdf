...
class MY_GUI():
    ...
    def set_init_window(self):
        ...
        self.init_window_name.geometry('1300x900+10+10')
        ...
        self.select.grid(row=15, column=0)
        ...
        #選擇框
        self.select_option = Listbox(self.init_window_name)
        self.select_option.grid(row=18, column=0, columnspan=10)
